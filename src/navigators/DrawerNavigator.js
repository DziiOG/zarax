          ...
          <ProductProvider>
            <NavigationContainer>
              ...
              >
                ...
                <Drawers.Screen
                  name="Zarax"
                  component={ZaraxDialogStackScreen}
                />
                <Drawers.Screen
                  name="User"
  ...
  return (
    <ProductConsumer>
      {(value) => (
        ...
        >
          <ZaraxDialogStack.Screen
            name="ZaraxDialog"
            component={ZaraxComponentContainer}
          />
        </ZaraxDialogStack.Navigator>
      )}
    </ProductConsumer>
        ...
        <Stack.Navigator
          screenOptions={{
            headerTitle: (props) => (
              ...
              >
                <LottieView
                  source={require("../assets/calm.json")}
                  autoPlay
                  loop
                />
              </View>
      ...
      {(value) => (
        <View style={{ flex: 1 }}>
          <DrawerContentScrollView {...props}>
            <View style={styles.drawerContent}>
              ...
              <Drawer.Section style={styles.drawerContent}>
                ...
                <DrawerItem
                  icon={({ size }) => (
                    <Icon name="account" color="#d2d2d2" size={size}></Icon>
                  )}
                  label="Profile"
                  onPress={() => {
          ...
          <Drawer.Section style={styles.bottomDrawerSection}>
            <DrawerItem
              icon={({ color, size }) => (
                <Icon name="exit-to-app" color="#d2d2d2" size={size}></Icon>
              )}
              label="Sign Out"
              onPress={() => {
                props.signOut();
